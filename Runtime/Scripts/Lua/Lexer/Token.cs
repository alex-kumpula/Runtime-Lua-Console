...
namespace DCG.RuntimeConsole.Lua.Lexing
{
	class Token
	{
		...
		internal MoonSharp.Interpreter.Debugging.SourceRef GetSourceRef(bool isStepStop = true)
		{
			return new MoonSharp.Interpreter.Debugging.SourceRef(this.SourceId, this.FromCol, this.ToCol, this.FromLine, this.ToLine, isStepStop);
		}

		internal MoonSharp.Interpreter.Debugging.SourceRef GetSourceRef(Token to, bool isStepStop = true)
		{
			return new MoonSharp.Interpreter.Debugging.SourceRef(this.SourceId, this.FromCol, to.ToCol, this.FromLine, to.ToLine, isStepStop);
		}

		internal MoonSharp.Interpreter.Debugging.SourceRef GetSourceRefUpTo(Token to, bool isStepStop = true)
		{
			return new MoonSharp.Interpreter.Debugging.SourceRef(this.SourceId, this.FromCol, to.PrevCol, this.FromLine, to.PrevLine, isStepStop);
		}
	}
}
